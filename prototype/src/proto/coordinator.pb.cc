...
const char descriptor_table_protodef_coordinator_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "rueorfalse\030\001 \001(\010\"\022\n\020ListAllStripeCMD\"\223\001\n"
  "\017TransitionUpCMD\022/\n\004mode\030\001 \001(\0162!.coordin"
  "ator.TransitionUpCMD.MODE\022\014\n\004step\030\002 \001(\005\022"
  "\020\n\010doublegp\030\003 \001(\010\"/\n\004MODE\022\t\n\005BASIC\020\000\022\016\n\n"
  "BASIC_PART\020\001\022\014\n\010DESIGNED\020\0022\247\006\n\nFileSyste"
  "m\022:\n\tcreateDir\022\021.coordinator.Path\032\032.coor"
  "dinator.RequestResult\022B\n\014uploadStripe\022\027."
  "coordinator.StripeInfo\032\031.coordinator.Str"
  "ipeDetail\022B\n\016downloadStripe\022\025.coordinato"
  "r.StripeId\032\031.coordinator.StripeDetail\022T\n"
  "\026downloadStripeWithHint\022\035.coordinator.St"
  "ripeIdWithHint\032\033.coordinator.StripeLocat"
  "ion\022A\n\014deleteStripe\022\025.coordinator.Stripe"
  "Id\032\032.coordinator.RequestResult\022B\n\013upload"
  "Check\022\027.coordinator.StripeInfo\032\032.coordin"
  "ator.RequestResult\022F\n\021reportblockupload\022"
  "\025.coordinator.StripeId\032\032.coordinator.Req"
  "uestResult\022@\n\nlistStripe\022\025.coordinator.S"
  "tripeId\032\033.coordinator.StripeLocation\022N\n\016"
  "listAllStripes\022\035.coordinator.ListAllStri"
  "peCMD\032\033.coordinator.StripeLocation0\001\022H\n\014"
  "transitionup\022\034.coordinator.TransitionUpC"
  "MD\032\032.coordinator.RequestResult\022T\n\022setpla"
  "cementpolicy\022\".coordinator.SetPlacementP"
  "olicyCMD\032\032.coordinator.RequestResult2\016\n\014"
  "FromDataNodeb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_coordinator_2eproto = {
  &descriptor_table_coordinator_2eproto_initialized, descriptor_table_protodef_coordinator_2eproto, "coordinator.proto", 1700,
...
TransitionUpCMD::TransitionUpCMD(const TransitionUpCMD& from)
  ...
  ::memcpy(&mode_, &from.mode_,
    static_cast<size_t>(reinterpret_cast<char*>(&doublegp_) -
    reinterpret_cast<char*>(&mode_)) + sizeof(doublegp_));
  // @@protoc_insertion_point(copy_constructor:coordinator.TransitionUpCMD)
}

void TransitionUpCMD::SharedCtor() {
  ::memset(&mode_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&doublegp_) -
      reinterpret_cast<char*>(&mode_)) + sizeof(doublegp_));
}
