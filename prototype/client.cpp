...
//        fileSystemClient.DownLoadStripe("", "", 0);
        ...
        if(mode == 1) {
            fileSystemClient.TransformRedundancy(coordinator::TransitionUpCMD_MODE_BASIC,scaleratio==2,2);
        }else if(mode == 2){
            fileSystemClient.TransformRedundancy(coordinator::TransitionUpCMD_MODE_BASIC_PART,scaleratio==2,2);
        }else{
            fileSystemClient.TransformRedundancy(coordinator::TransitionUpCMD_MODE_DESIGNED,scaleratio==2,2);
        }
